        ...
        children: [
          ...
          InputDecorator(
            decoration: InputDecoration(
              filled: true,
              fillColor: tournamentController.isPartner.value == true
            ...
            child: DropdownButtonHideUnderline(
              child: DropdownButton<String>(
                icon: Icon(Icons.keyboard_arrow_down,
                    color: tournamentController.isPartner.value == true
                        ? AppColor().primaryBackGroundColor
                        : AppColor().lightItemsColor),
                value: tournamentController.partnerValue.value,
                items: <String>[
                  'EASPORTS',
                  'ESportsNG',
                  'Others',
                ...
                onChanged: (value) {
                  tournamentController.partnerValue.value = value;
                  debugPrint(value);
                  tournamentController.partnersController.text = value!;
                  tournamentController.handleTap('partner');
                },
                hint: CustomText(
                  title: "Partners",
                  color: tournamentController.isPartner.value == true
          ...
          InputDecorator(
            decoration: InputDecoration(
              filled: true,
              fillColor: tournamentController.isStaff.value == true
                  ? AppColor().primaryWhite
                  : AppColor().bgDark,
              focusedBorder: OutlineInputBorder(
                  borderSide:
            ...
            child: DropdownButtonHideUnderline(
              child: DropdownButton<String>(
                icon: Icon(Icons.keyboard_arrow_down,
                    color: tournamentController.isStaff.value == true
                        ? AppColor().primaryBackGroundColor
                        : AppColor().lightItemsColor),
                value: tournamentController.staffValue.value,
                items: <String>[
                  'EASPORTS',
                  'ESportsNG',
                  'Others',
                ...
                onChanged: (value) {
                  tournamentController.staffValue.value = value;
                  debugPrint(value);
                  tournamentController.staffController.text = value!;
                  tournamentController.handleTap('staff');
                },
                hint: CustomText(
                  title: "Staff",
                  color: tournamentController.isStaff.value == true
