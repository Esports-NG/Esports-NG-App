...
import 'package:e_sport/ui/screens/account/team/apply_as_player.dart';
import 'package:e_sport/ui/screens/account/team/edit_team_profile.dart';
import 'package:e_sport/ui/screens/account/team/player_application_list.dart';
import 'package:e_sport/ui/screens/account/team/team_players_list.dart';
...
import 'package:e_sport/ui/screens/team/teams_games_played_list.dart';
...
class _AccountTeamsDetailState extends State<AccountTeamsDetail> {
  ...
  Future getTeamDetails() async {
    ...
    var response = await http.get(
        Uri.parse("${ApiLink.getAllTeam}?t_s=${widget.item.slug}"),
        headers: {
    ...
    setState(() {
      _details = TeamModel.fromJson(json['data']);
      _isFetching = false;
    });
  }

  Future getTeamFollowers() async {
    var followers = await teamController.getTeamFollowers(widget.item.slug!);
    setState(() {
      ...
      body: _details == null || _isFetching
          ...
          : SingleChildScrollView(
              ...
              children: [
                GestureDetector(
                  onTap: () =>
                      Helpers().showImagePopup(context, _details!.cover!),
                  child: Stack(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            InkWell(
                              onTap: () => Get.to(() =>
                                  UserDetails(slug: _details!.owner!.slug!)),
                              child: Stack(
                                alignment: Alignment.bottomRight,
                                children: [
