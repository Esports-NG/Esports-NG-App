...
import 'package:e_sport/ui/widgets/game/game_modes_item.dart';
                  ...
                  Stack(
                    ...
                    children: [
                      details!.cover == null
                          ...
                          : GestureDetector(
                              onTap: () => Helpers()
                                  .showImagePopup(context, details!.cover!),
                            ...
                            details!.profilePicture == null
                                ...
                                : GestureDetector(
                                    onTap: () => Helpers().showImagePopup(
                                        context, details!.profilePicture!),
                                    child: CachedNetworkImage(
                                      height: Get.height * 0.1,
                                      width: Get.height * 0.1,
                                      progressIndicatorBuilder:
              ...
              Padding(
                ...
                child: Column(
                    ...
                    children: [
                      ...
                      Gap(Get.height * 0.02),
                      details!.gameModes!.isEmpty
                          ? EmptyStateBuilder.build(
