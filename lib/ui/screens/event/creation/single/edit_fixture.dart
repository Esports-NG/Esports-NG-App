...
class EditFixture extends StatefulWidget {
  const EditFixture({super.key, required this.fixture, required this.event});
  final EventModel event;
  final FixtureModel fixture;

  @override
  State<EditFixture> createState() => _EditFixtureState();
}

class _EditFixtureState extends State<EditFixture> {
  ...
  void setValues() {
    tournamentController.selectedHomePlayer.value = widget.event.players!
        .firstWhere(
            (e) => e.inGameName == widget.fixture.homePlayer!.inGameName!);
    tournamentController.selectedAwayPlayer.value = widget.event.players!
        .firstWhere(
            (e) => e.inGameName == widget.fixture.awayPlayer!.inGameName!);
    ...
    tournamentController.addFixturesHomePlayerScoreController.text =
        widget.fixture.homeScore != null
            ? widget.fixture.homeScore.toString()
            : "";
    tournamentController.addFixturesAwayPlayerScoreController.text =
                  ...
                  GestureDetector(
                      onTap: () async {
                        ...
                        await tournamentController
                            .editFixtureForPlayer(widget.fixture.slug!);
                        setState(() {
                          _isLoading = false;
                        });
                      },
