...
import 'package:e_sport/ui/screens/account/community/edit_community_profile.dart';
...
import 'package:e_sport/ui/widgets/community/community_games_covered_item.dart';
import 'package:e_sport/ui/widgets/community/community_games_covered_list.dart';
...
import '../extra/no_item_page.dart';
...
class _AccountCommunityDetailState extends State<AccountCommunityDetail> {
  ...
  Future fetchRecentPosts() async {
    ...
    var response = await http.get(
        Uri.parse(ApiLink.postFromGroup(widget.item.slug!, "community")),
        headers: {
          "Authorization": "JWT ${authController.token}",
          "Content-type": "application/json"
        });
    print("community post: ${response.body}");
  ...
  Future getDetails() async {
    var communityDetails =
        await communityController.getCommunityData(widget.item.slug!);
    setState(() {
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        InkWell(
                          onTap: () {
                            Get.to(
                                () => UserDetails(slug: details!.owner!.slug!));
                          },
                          child: Row(
                            children: [
                              Stack(
                              ...
                              CustomText(
                                  title:
                                      details!.owner!.fullName!.toCapitalCase(),
                                  size: 14,
