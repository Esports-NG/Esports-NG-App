...
import 'package:e_sport/ui/screens/event/creation/single/edit_fixture.dart';
import 'package:e_sport/ui/screens/event/creation/team/edit_fixture_team.dart';
                      ...
                      children: [
                              ...
                              children: [
                                GestureDetector(
                                  onTap: () => Helpers().showImagePopup(
                                      context,
                                      widget.fixture.tournament!.games![0]
                                          .profilePicture!),
                                  child: ClipRRect(
                                    borderRadius:
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            dateHasPassed(widget.fixture.fixtureDate!) ==
                                        false &&
                                    widget.fixture.livestreams!.isNotEmpty
                                ? Stack(
                                    children: [
                                      Icon(
                    ...
                    child: InkWell(
                      ...
                      child: widget.fixture.livestreams!.isEmpty
                          ? SizedBox(
                              ...
                              child: Center(
                                  child: CustomText(title: "No Livestream")))
                          : ColorFiltered(
                              ...
                              child: Image.network(
                                widget.fixture.livestreams![0].platform!
                                    .secondaryImage!,
                                // height: 25,
                                fit: BoxFit.cover,
              ...
              if (widget.event.community != null)
                Visibility(
                  ...
                  child: Positioned(
                      right: 0,
                      child: menuAnchor(
                          widget.fixture, widget.fixture.tournament!)),
                )
            ],
          ),
        ),
                ...
                SizedBox(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      dateHasPassed(widget.fixture.fixtureDate!) ==
                              false //&& widget.fixture.livestreams!.isNotEmpty
                          ? Stack(
                              children: [
                                Icon(
                                  Icons.calendar_today,
